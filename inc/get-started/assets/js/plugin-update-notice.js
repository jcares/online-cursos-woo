jQuery(document).ready(function () {
    const canvas = document.getElementById('online-education-academy-notice-confetti');
    if (canvas && typeof confetti === 'function') {
        const online_education_academy_Confetti = confetti.create(canvas, {
            resize: true
        });

        setTimeout(function () {
            online_education_academy_Confetti({
