...
jQuery(document).ready(function(){
    ...
    jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-menu').attr("checked","checked");

    jQuery('#online-education-academy-setup-menu').click(function(){
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-menu').css("display","block");
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-contact').css("display","none");
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-widget').css("display","none");
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-social-icon').css("display","none");
    });

    jQuery('#online-education-academy-setup-contact').click(function(){
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-menu').css("display","none");
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-contact').css("display","block");
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-widget').css("display","none");
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-social-icon').css("display","none");
    });

    jQuery('#online-education-academy-setup-widget').click(function(){
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-menu').css("display","none");
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-contact').css("display","none");
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-widget').css("display","block");
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-social-icon').css("display","none");
    });

    jQuery('#online-education-academy-setup-social').click(function(){
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-menu').css("display","none");
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-contact').css("display","none");
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-widget').css("display","none");
        jQuery('#online-education-academy-demo-setup-guid .online-education-academy-setup-social-icon').css("display","block");
    });
});